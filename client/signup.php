                ...
                <div class="row flex-grow">
                    <div class="col-md-4 p-0">
                        <div class="auth-form-light text-left p-5">
                            ...
                            <form action="register.php" role="form" id=""  method="post" enctype="multipart/form-data" class="">  
                                <div class="form-group first">
                                    <input type="text" class="form-control form-control-lg" name="username" id="username" placeholder="Enter Username" required>
                                </div>
                                <div class="form-group first">
                                    <input type="text" class="form-control form-control-lg" name="firstname" id="firstname" placeholder="Enter First Name" required>
                                </div>
                                <div class="form-group first">
                                    <input type="text" class="form-control form-control-lg" name="lastname" id="lastname" placeholder="Enter Last Name" required>
                                </div>
                                <div class="form-group first">
                                    <input type="text" class="form-control form-control-lg" name="email" id="email" placeholder="Enter Email" required>
                                </div>
                                <div class="form-group first">
                                    <input type="number" class="form-control form-control-lg" name="mobilenumber" id="phonenumber" placeholder="Enter Phone Number" required>
                                </div>
                                <div class="form-group last">
                                    <input type="password" name="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Password" required>
                                </div>
                                <div class="mt-3">
                                    <button name="adduser" class="btn btn-block btn-info btn-lg font-weight-medium auth-form-btn">SIGN UP</button>
                                </div>
