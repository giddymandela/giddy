...
<body id="body">
        ...
        <div class="col-md-5 col-md-offset-1" id="logo_col">
            <h1 class="text-center"><a class="text-primary" href="#" id="logo"><strong> </strong><strong>Bursary Notifications</strong></a></h1></div>
        <div class="col-md-6">
            <div>
                <p class="text-center">Contact Us:</p>
            </div>
            <div>
                <p class="text-center"><strong>+254 794-013-215 / +254 758-013-869</strong></p>
            </div>
            <div>
                <p class="text-center">Email Us:</p>
            </div>
            <div>
                <p class="text-center">vihigaCounty@gmail.com</p>
            </div>
            <div>
    ...
    <div class="row">
        <div class="col-md-12">
            <footer id="footer">
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="text-center"><span></span><strong>Bursary notifications</h4></div>
                </div>
            </footer>
        </div>
    </div>
